...
function firebugFrameLoad(Firebug)
{
    ...
    Firebug.registerTracePrefix("fireCanary;", "DBG_FIRECANARY", true,
        "chrome://firecanary/skin/firecanary.css");
    ...
    var config = {id: "fireCanary@gerionsecurity.com"};
    Firebug.registerExtension("firecanary", config);
}
...
function firebugFrameUnload(Firebug)
{
    ...
    Firebug.unregisterExtension("firecanary");
    Firebug.unregisterTracePrefix("fireCanary;");
}
